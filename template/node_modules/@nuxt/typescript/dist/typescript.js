/*!
 * @nuxt/typescript v2.5.1 (c) 2016-2019
...
async function setup(tsConfigPath, options = {}) {
  if (_setup) {
    return
  }
  _setup = true;

  const config = await fsExtra.readJSON(tsConfigPath);
  await fsExtra.writeJSON(tsConfigPath, defaultsDeep_1(config, defaultTsJsonConfig), { spaces: 2 });
